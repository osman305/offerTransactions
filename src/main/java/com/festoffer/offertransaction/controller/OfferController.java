...
import com.festoffer.offertransaction.validation.OfferTransactionValidation;
...
public class OfferController {
    ...
    public OfferTransactionModel applyOffer(@RequestBody OfferTransactionRequest offerTransactionRequest) {
        ...
        OfferTransactionValidation.validateOfferTransactionRequest(offerTransactionRequest);
